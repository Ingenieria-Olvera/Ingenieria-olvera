...
  - Earned from my progress in creating a personal assistant through the school year, awarding my innovation, design, and programming prowess. **This award was a significant recognition of my hands-on approach to engineering, highlighting my ability to innovate and implement complex designs from concept to a functioning prototype within a collaborative lab environment. It reinforced my commitment to continuous learning and application of practical skills.**

- **MITx 6.002.1x**
  - I am currently taking on EdX MITx 6.002.1x, Circuits and Electronics 1: Basic Circuit Analysis, and I am getting my certificate here. This has truly challanged me in the relm of electronics, I started with no real knowldge on the topic and left with a good grasph on Electronics. **This course has been transformative, fundamentally changing my understanding of electrical engineering. It challenged me to develop a robust analytical framework for circuit analysis, moving from a conceptual understanding to a deep, practical grasp of foundational electronic principles.**
